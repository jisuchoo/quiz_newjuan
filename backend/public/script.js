...
const quizData = [
  ...
  { 
    question: "난임치료후산후관리지원금은 난임치료 후 \n출산 시 최대 400만원을 지급한다.", 
    answer: true,
    score: 6.25 
  },
  { 
    question: "여성생애1-5종수술비는 49세 이전에 \n자궁근종 관혈수술 시 4종으로 지급한다.", 
    answer: true,
    score: 6.25 
  },
  { 
    question: "여성생애1-5종수술비는 50세 이후에 \n디스크 수술 시 4종으로 지급한다.", 
    answer: true,
    score: 6.25 
  },
  { 
  ...
  { 
    question: "정부는 2019년 일반검진을 \n20대까지 확대하였다.", 
    answer: true,
    score: 6.25 
  },
  { 
    question: "일반검진을 20대까지 확대한 이유는 \n암 발생 연령이 20대로 낮아져서 이다.", 
    answer: false,
    score: 6.25 
  },
  { 
  ...
  { 
    question: "건강검진에서 대장용종을 제거한 경우 \n질병1-5종 수술비에서 1종으로 지급된다.", 
    answer: false,
    score: 6.25 
  },
  { 
...
function finishQuiz() {
  ...
  if (score >= 90) {
    ...
    finalMessage.innerHTML = `대단합니다! <b>${username}</b>님은 정보미팅의 핵심을 완벽히 마스터하셨습니다. <br>지점의 전문 리더로서 적극적인 활동이 기대됩니다! ✨`;
  } else if (score >= 60) {
    ...
    finalMessage.innerHTML = `아쉬운 결과입니다. <b>${username}</b>님, 정보미팅을 다시 한번 숙지하여 고객에게 더 정확한 가치를 전달해 보세요! 🔥`;
  }
